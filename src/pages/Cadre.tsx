...
import { User, SupervisionRecord, classroomsByFloor, getUniqueSupervisionRecords, AnomalyRecord, AttendanceRecord, classes, getUniqueAttendanceRecords } from '../data'
...
function Cadre({ user, onLogout }: CadreProps) {
